...
public class GameManagerIntros : MonoBehaviour
{
    ...
    void Update()
    {
        if (GlobalGameManager.Instance.PlayerStats.TotalCoins >= StaticScoreHolder.fishCaughtToBeIntroduced[0] && !StaticScoreHolder.cat1IntroPlayed)
        {
            temp = Instantiate(spawnObjects[0], spawnPoint.transform.position, Quaternion.identity);
            StaticScoreHolder.cat1IntroPlayed = true;
            Invoke("MoveToBack", 3);
        }
        if (GlobalGameManager.Instance.PlayerStats.TotalCoins >= StaticScoreHolder.fishCaughtToBeIntroduced[1] && !StaticScoreHolder.cat2IntroPlayed)
        {
        ...
        if (GlobalGameManager.Instance.PlayerStats.TotalCoins >= StaticScoreHolder.fishCaughtToBeIntroduced[2] && !StaticScoreHolder.cat3IntroPlayed)
        {
        ...
        if (GlobalGameManager.Instance.PlayerStats.TotalCoins >= StaticScoreHolder.fishCaughtToBeIntroduced[3] && !StaticScoreHolder.cat4IntroPlayed)
        {
        ...
        if (GlobalGameManager.Instance.PlayerStats.TotalCoins >= StaticScoreHolder.fishCaughtToBeIntroduced[4] && !StaticScoreHolder.cat5IntroPlayed)
        {
        ...
        if (GlobalGameManager.Instance.PlayerStats.TotalCoins >= StaticScoreHolder.fishCaughtToBeIntroduced[5] && !StaticScoreHolder.cat6IntroPlayed)
        {
        ...
        if (GlobalGameManager.Instance.PlayerStats.TotalCoins >= StaticScoreHolder.fishCaughtToBeIntroduced[6] && !StaticScoreHolder.cat7IntroPlayed)
        {
